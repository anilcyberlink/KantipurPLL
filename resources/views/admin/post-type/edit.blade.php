...
<form class="form-horizontal" role="form" action="{{ url('type/posttype', $data->id) }}" method="post" enctype="multipart/form-data">
	...
	<div class="col-md-10">
        ...
        <div class="col-lg-8">
          <div class="bs-component">
          	 <textarea class="form-control my-editor" id="" name="caption" rows="25" autocomplete="off">{{$data->caption}}</textarea>           
          </div>
        </div>
      </div> 
      ...
      <div class="form-group">
        ...
        <div class="col-lg-8">
          <div class="bs-component">
            <textArea name="content" class="form-control my-editor" rows="25" autocomplete="off"> {{$data->content}} </textArea>
          </div>
        </div>
      </div> 
